...
def create_symbol(payload: SymbolCreate, db: Session = Depends(get_db)) -> Symbol:
...
def update_symbol(symbol_id: int, payload: SymbolUpdate, db: Session = Depends(get_db)) -> Symbol:
